국내 최대 가상화폐(암호화폐) 거래소 빗썸의 매각이 사실상 무산되는 분위기다.

30일 업계에 따르면 BK컨소시엄이 빗썸 지주사 비티씨홀딩컴퍼니의 인수 잔금을 전날까지 납입하지 않은 것으로 알려졌다.

이날까지 낼 가능성도 크지 않아 업계에서는 BK컨소시엄의 인수가 사실상 물 건너간 것으로 보고 있다.
...
하지만 계약금으로 1억 달러(약 1200억 원)를 낸 이후 잔금을 제때 치르지 못해 인수 무산 의혹이 제기돼왔다.
...
원칙적으로 계약을 파기한 쪽이 손해를 보는 것이 일반적이지만 금액이 1000억 원대로 큰 만큼 양측이 합의를 보지 못하면 법정 분쟁으로 비화할 것으로 전망된다.

@highlight

BK컨소시엄은 국내 최대 가상화폐 거래소인 빗썸을 매입하는 계약을 체결했으나 잔금을 제때 치르지 못하여 인수 무산 의혹이 제기되어왔었고 사실상 무산되는 분위기다. 
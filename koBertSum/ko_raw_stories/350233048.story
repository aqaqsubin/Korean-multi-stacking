이충후 셰프가 ‘삼성 전기레인지 인덕션’을 사용해 요리를 보여주고 있다.

삼성전자가 ‘삼성 셰프컬렉션 인덕션과 함께 시원한 여름 나기’를 주제로 한 소비자 대상 쿠킹클래스를 24일 열었다.

이 쿠킹클래스는 서울 중구 충무로에 위치한 ‘샘표 우리맛 공간’에서 진행됐으며 ‘삼성 클럽드셰프 코리아’ 멤버인 이충후 셰프가 요리를 시연했다.

이번 행사에 참석한 소비자들은 올해 새롭게 출시된 ‘삼성 셰프컬렉션 인덕션’을 활용해 직접 요리를 만들어보면서 자연스럽게 제품 특징을 체험했다.
...
삼성 셰프컬렉션 인덕션은 국내 최고 수준인 최대 6천800W(와트)의 강력한 화력을 자랑하며 1개의 인덕션 화구를 최대 4개로 분할해 사용 가능한 ‘콰트로 플렉스존’을 갖추고 있다.

또 △기기 작동 상태와 화력을 직관적으로 확인할 수 있는 ‘LED 가상불꽃’ △정교한 온도 조절은 물론 탈부착이 가능해 청소가 간편한 ‘마그네틱 다이얼’ 등 차별화된 편의 기능들로 소비자들로부터 호평을 받고 있다.

KT가 소방청, 세브란스병원과 함께 응급의료체계의 전 단계를 5G와 ICT 기술로 스마트하게 바꾸는 응급의료 서비스를 개발한다고 12일 밝혔다.
...
연간 천만 건이 넘는 119 신고는 대부분 음성통화로 수신되지만, 119신고센터에서 상황을 정확히 파악하기 위해 신고자에게 영상통화를 하고 싶어도 시스템 미비로 할 수 없다.
...
구급차 내부에 5G 통신환경을 구축하고, 카메라와 실시간 현장 대응 카메라 등으로 구급대원과 세브란스 병원 의료진이 실시간 소통할 수 있도록 하는 것이다.
...
KT가 소방청, 세브란스병원과 함께 5G와 ICT 기술로 스마트하게 바꾸는 응급의료 서비스를 개발을 알렸으며, 이날  우선 119 신고센터와 응급환자가 상호 영상통화를 할 수 있는 '5G 기반 119 영상통화 신고 서비스'를 전국 상용화를 이룸으로써 신고자에게 직접 영상통화를 걸어 정확한 상황을 파악하여 치료 골든타임을 지킬 수 있게 되었다.
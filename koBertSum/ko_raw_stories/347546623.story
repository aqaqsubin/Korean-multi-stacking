...
대전시는 제로페이 전국 확산 및 정부정책에 적극 부응하고 소상공인들의 경영안정 지원을 위해 마케팅 예산을 확보해 온라인, 오프라인 가맹점 접수처 확대, 소비자 홍보 이벤트 추진 등 제로페이 활성화에 적극 나선다고 3일 밝혔다.

'제로페이'에 가입한 소상공인 가맹점의 결제수수료는 연매출액을 기준으로 8억 원 이하는 0％, 8~12억 원은 0.3％, 12억 초과는 0.5％가 적용되고 일반 가맹점의 결제수수료는 결제사업자가 자율적으로 결정하게 된다.
...
대전시에 따르면 제로페이 활성화를 위해 제로페이 가입 소상공인 가맹점에게 연매출액 8억원 이하일 경우 카드수수료를 0% 적용하고, 이용 금액의 40% 소득공제 혜택을 제공할 예정이며, 이는 하나은행, 농협, 대전신용보증재단과 함께 할 계획이다.
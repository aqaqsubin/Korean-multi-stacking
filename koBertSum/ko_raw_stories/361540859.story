30일 인터넷, 10월 14일 모바일 대출서비스 시작무주택 서민들이 디딤돌(주택 구입)·버팀목(전세) 대출을 받기가 한결 간편해진다.
...
한정된 예산으로 운영되는 주택도시기금을 지원이 더 절실한 수요자에게 집중하자는 취지다.

지금까지는 대출신청자(배우자 포함)의 소득 기준만 따졌으나, 앞으로는 주택 구입자금 대출의 경우 자산이 잠정 3억 7000만 원 이내, 전·월세 대출의 경우 잠정 2억 8000만 원 이내에 해당해야만 대출이 가능하다.
...
국토교통부가 주택도시기금을 통해 주택 구입·전세 비용을 지원하는 디딤돌·버팀목 대출에 '기금e든든'이라는 이름의 비(非)대면 온라인 대출 서비스를 도입함에 따라, 온라인에서 대출을 신청한 뒤 대출 약정 단계에서 딱 한 번만 은행에 가면 되기 때문에 대출 신청부터 대출 심사 종료까지 걸리는 기간이 기존 1∼2주에서 약 5영업일로 크게 단축된다.
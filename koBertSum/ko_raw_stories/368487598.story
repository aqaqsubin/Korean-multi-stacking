...
휠라 블랙프라이데이는 공식 온라인몰과 무신사 스토어(슈즈 한정) 외 주요 온라인 쇼핑몰에서 동시에 진행된다.

내달 2일 자정부터는 '휠라 사이버먼데이' 행사로 블랙프라이데이로 시작한 쇼핑 축제의 여흥을 계속 이어나간다.

휠라 공식 온라인몰에서만 단독 진행하는 사이버 먼데이 행사에서는 휠라 헤리티지 슈즈, 일부 콜라보 아이템을 포함한 휠라 및 휠라 키즈 인기 제품을 파격 할인가에 제공할 계획이다.
...
휠라(FILA)는 연중 최대 쇼핑 명절인 블랙프라이데이를 맞아 오는 29일 자정부터 12월 1일까지 '휠라 블랙프라이데이' 이벤트를 진행하는데, 여러 독창적인 행사 기획과 함께 휠라를 대표하는 인기 제품 최대 반값으로 한정 판매하기로 하였다.